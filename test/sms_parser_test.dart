...
void main() {
  ...
  void debugParse(String name, String sms) {
    final result = parser.parseSms(sms);
    print('[$name]');
    print('  success: ${result.success}');
    print('  code: "${result.code}"');
    print('  company: "${result.sender}"');
    print('');
  }

  test('debug all samples', () {
    debugParse('极兔速递',
        '【极兔速递】请凭3-2-5031到长春理工南区菜鸟驿站取运单尾号2081包裹');
    debugParse('京东快递',
        '【京东快递】取件码J-2-5216，您的快件尾号1494已送达长春理工大学南校区服务站，地址：吉林长春市朝阳区长春理工大学南校区，取件和寄件可咨询 3.cn/-2O64NfS');
    debugParse('圆通速递',
        '【圆通速递】请凭4-2-4077到长春理工南区菜鸟驿站取件，地址：校园快递服务中心（南研楼一楼）。');
    debugParse('圆通快递',
        '【圆通快递】请凭4-6-3017到长春理工南区菜鸟驿站取运单尾号6799包裹');
  });
